            ...
            HStack {
                ...
                Button(action: {
                    Task {
                        ...
                        try await Persistance.savePlayer(withName: selectedPlayer1.name, andPlayer: player1)
                        try await Persistance.savePlayer(withName: selectedPlayer2.name, andPlayer: player2)
